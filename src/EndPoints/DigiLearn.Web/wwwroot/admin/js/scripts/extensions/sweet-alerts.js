...
$(document).ready(function () {
	...
	$('#html-alert').on('click', function () {
		Swal.fire({
			...
			type: 'info',
			html: 'میتونید از <b>texts ضخیم</b> ، ' +
	...
	$('#confirm-color').on('click', function () {
		Swal.fire({
			...
			type: 'warning',
			showCancelButton: true,
			confirmButtonText: 'بله ، Delete کن!',
