...
i18next.addResourceBundle('fa_p', 'translation', {
	key: "لورم ایپسوم texts ساختگی با تولید سادگی nameفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزnameه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و userدهای متtype با هدف بهبود ابزارهای userدی"
});
