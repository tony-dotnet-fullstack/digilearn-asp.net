...
jQuery.extend(jQuery.validator.messages, {
    ...
    email: "لطفا یک آدرس Email معتبر وارد کنید.",
    url: "لطفا یک URL معتبر وارد کنید.",
    date: "لطفا یک dates معتبر وارد کنید.",
    dateISO: "لطفا یک dates معتبر وارد کنید (ISO).",
...
stepsValidation.validate({
	...
	messages: {
		emailAddress: {
			required: "وارد کردن Email الزامی است.",
			email: "لطفا یک Email معتبر وارد نمایید."
		}
	}
});
