	...
	return e.define("select2/i18n/fa", [], function () {
		return {
			errorLoading: function () {
				return "امکان بارگذاری result وجود ندارد."
			},
			inputTooLong: function (e) {
				var t = e.input.length - e.maximum,
					n = "لطفاً " + t + " کاراکتر را Delete نمایید";
				return n
			},
			...
			loadingMore: function () {
				return "در حال بارگذاری result بیشتر..."
			},
			...
			removeAllItems: function () {
				return "all موارد را Delete کنید"
			}
		}
	}), {
		define: e.define,
...
(function (window, document, $) {
	...
	$(".max-length").select2({
		...
		placeholder: "حداکثر 2 گزینه Select"
	});
	...
	$(".select2-data-ajax").select2({
		...
		placeholder: 'برای یک repository SERCH کنید',
	...
	$.fn.select2.amd.require(['select2/compat/matcher'], function (oldMatcher) {
		$(".select2-customize-result").select2({
			...
			width: '100%',
			language: "fa",
			placeholder: "SERCH را با 'ب' شروع کنید",
