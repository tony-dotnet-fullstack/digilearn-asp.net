...
(function (window, document, $) {
	...
	$.extend( true, $.fn.dataTable.defaults, {
		language: {
			...
			"sInfo":           "show _START_ تا _END_ از _TOTAL_ رکورد",
			"sInfoEmpty":      "show 0 تا 0 از 0 رکورد",
			"sInfoFiltered":   "(Filter شده از _MAX_ رکورد)",
			"sInfoPostFix":    "",
			"sInfoThousands":  ",",
			"sLengthMenu":     "show _MENU_ رکورد",
			...
			"oAria": {
				"sSortAscending":  ": Active سازی show به صورت صعودی",
				"sSortDescending": ": Active سازی show به صورت نزولی"
			}
		}
	} );
	...
	var donustChartStatistics_1 = {
		...
		series: [70, 30, 40],
		labels: ["نصب", "view صفحه", "userان Active"],
		stroke: {
			width: 2
		},
